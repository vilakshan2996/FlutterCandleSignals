    ...
    if(candle.trades != null){
      for(int i = 0; i < candle.trades!.length; i++){
        ...
        if (trade.isBuyer) {
          ...
          trianglePath.moveTo(x, y - 10); // Top point of the triangle
          trianglePath.lineTo(x - 10, y + 10); // Bottom-left point of the triangle
          trianglePath.lineTo(x + 10, y + 10); // Bottom-right point of the triangle
        } else {
          // Red triangle (pointing down)
          trianglePath.moveTo(x, y + 10); // Bottom point of the triangle
          trianglePath.lineTo(x - 10, y - 10); // Top-left point of the triangle
          trianglePath.lineTo(x + 10, y - 10); // Top-right point of the triangle
        }
        
        trianglePath.close(); // Closes the path to form a triangle
        
        canvas.drawPath(trianglePath, tradePaint);
      }
    }
    // Draw volume bar
